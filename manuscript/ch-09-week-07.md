# Chapter 9: How to Construct a Model

> Week 7 of the 13-week sequence.
...
- Otto, S. P. & Day, T. (2007). How to construct a model. In *A Biologist's Guide to Mathematical Modeling in Ecology and Evolution*. Princeton University Press.
- Otto, S. P. & Day, T. (2007). Numerical and graphical techniques. In *A Biologist's Guide to Mathematical Modeling in Ecology and Evolution*. Princeton University Press.


## Lab: How to Construct a Model

A> **Run this lab.** Notebooks and data files are available at:
A> [https://www.behavioral-data-science.org/book/labs/week-07](https://www.behavioral-data-science.org/book/labs/week-07)
A>
