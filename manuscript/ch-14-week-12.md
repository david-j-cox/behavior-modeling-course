...
- Raschka, S. (2020). Model evaluation, model selection, and algorithm selection in machine learning. *arXiv*. https://doi.org/10.48550/arXiv.1811.12808
...
- Gupta, S. C. (2022). MLOps: Machine learning lifecycle. *Towards Data Science*. https://medium.com/towards-data-science/machine-learning-lifecycle-in-mlops-era-5b45284c0e34
- Woods, A. D. et al. (2024). Best practices for addressing missing data through multiple imputation. *Infant and Child Development*, *33*(1), e2407. https://doi.org/10.1002/icd.2407
- Côté, P.-O. et al. (2024). Data cleaning and machine learning: A systematic literature review. *Automated Software Engineering*, *31*(2), Article 54. https://doi.org/10.1007/s10515-024-00453-w
