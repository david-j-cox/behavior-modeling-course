...
1. You must clearly disclose and identify the use of AI-based tools in your work. Any work that utilizes AI-based tools must be clearly marked as such, including the specific tool(s) used.
2. You must be transparent in how you used the AI-based tool, including what work is your original contribution. You are required to disclose all use of AI in all assignments; you must submit conversations/chats with AI. If you utilize AI, please provide a transcript of your prompts and interactions with AI as part of the assignment, for full transparency.
3. You must ensure your use of AI-based tools does not violate any copyright or intellectual property laws.
4. You must not use any tools (AI-based or otherwise) to cheat on assessments. It is expected that your responses on assessments (quizzes, exams) are solely your own.
